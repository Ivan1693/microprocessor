...
if [ "$VAR1" = "$VAR3" ];then
	echo -e "\033[1;34m\n[alu]\033[0m" ; ls alu ; echo -e "\033[1;34m\n[basic]\033[0m" ; ls basic;echo -e "\033[1;34m\n[memory]\033[0m" ; ls memory;echo -e "\n\033[1;34m[micro]\033[0m" ; ls micro;echo -e "\n"
	exit 1
fi

echo -e "${LBL}ESCOM${NC} Arquitectura de computadoras: Microcontrolador 4bits - LagartijaX4\nAnalisis de codigo fuente de paquetes y componentes con GHDL \n"
